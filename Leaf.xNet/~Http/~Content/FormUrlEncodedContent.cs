...
namespace Leaf.xNet
{
    ...
    public class FormUrlEncodedContent : BytesContent
    {
        ...
        /// <param name="encoding">
        ///     Кодировка, применяемая для преобразования параметров запроса. Если значение параметра равно
        ///     <see langword="null" />, то будет использовано значение <see cref="P:System.Text.Encoding.UTF8" />.
        /// </param>
        /// <exception cref="T:System.ArgumentNullException">
        ///     Значение параметра <paramref name="content" /> равно
        ///     <see langword="null" />.
        /// </exception>
        ...
        public FormUrlEncodedContent(IEnumerable<KeyValuePair<string, string>> content, bool dontEscape = false, Encoding encoding = null)
        {
            ...
            var queryString = Http.ToPostQueryString(content, dontEscape, encoding);
        ...
        public FormUrlEncodedContent(Dictionary<string, string> content, bool dontEscape = false, Encoding encoding = null) : this(content.ToList(), dontEscape, encoding) { }
    }
}